(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-history__body")) new swiper_core_Swiper(".slider-history__body", {
            ...
            navigation: {
                prevEl: ".controls-slider-history__arrow_prev",
                nextEl: ".controls-slider-history__arrow_next"
            },
            breakpoints: {
                320: {
                    spaceBetween: 15
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (!history) {
            console.error("Елемент з ID 'history' не знайдено!");
            return;
        }
        window.addEventListener("scroll", (function() {
            const historyPosition = history.getBoundingClientRect().top;
            const windowHeight = window.innerHeight;
            if (historyPosition < windowHeight / 2) scrollToTopBtn.classList.add("show"); else scrollToTopBtn.classList.remove("show");
        }));
